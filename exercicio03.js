...
pessoa.andar = function(metrosAndados) {pessoa.caminhouQuantosMetros += metrosAndados; pessoa.andando = true; };
...
console.log(pessoa.nomeCompleto()); // Olá! Meu nome é Rafael Cruz
...
pessoa.apresentacao = function() {
    ...
    return "Olá, eu sou "+validaSexo+" "+pessoa.nome+" "+pessoa.sobrenome+" tenho "+pessoa.idade+" "+validaIdade+", "+pessoa.altura+", meu peso é "+pessoa.peso+" e só hoje, eu já caminhei "+pessoa.caminhouQuantosMetros+" "+validaMetros+"!";
