(function() {
    ...
    */
    ...
    brasil.unshift('Acre', 'Amazonas', 'Pará', 'Roraima');
    console.log(brasil);
    ...
    */
    ...
    var nordeste = ['Alagoas', 'Sergipe', 'Pernambuco', 'Bahia', 'Paraiba', 'Ceará', 'Rio grande do norte', 'Piaui', 'Maranhão'];
